...
button.addEventListener("click", function () {
  ...
  if (
    ...
    alert(
      "Invalid:The first part should have 3 digits and should not be 000, 666, or between 900 and 999. "
    );
    return false;
  }
  ...
  if (secondPart.length !== 2 || secondPart < 1 || secondPart > 99) {
    alert(
      "Invalid: The second part should have 2 digits and it should be from 01 to 99. "
    );
    return false;
  }
  ...
  if (
    thirdPart.length !== 4 ||
    Number(thirdPart) < 1 ||
    Number(thirdPart) > 9999
  ) {
    alert(
      "Invalid: The third part should have 4 digits and it should be from 0001 to 9999."
    );
    return false;
  }
  alert("Valid");
